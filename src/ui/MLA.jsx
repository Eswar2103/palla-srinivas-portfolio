  ...
  return (
    <div>
      ...
      <div className="mx-5 sm:mx-35 border border-none rounded-2xl bg-stone-50 shadow-xl/30 py-5 mt-15 px-4">
        ...
        <p className="px-0 mt-3 text-md sm:text-[16px] mb-4">
          <strong>
            Under the Leadership of MLA Shri Palla Srinivasa Rao garu, Gajuwaka
            is undergoing significant development, with various infrastructure
        ...
        <section className="grid sm:grid-cols-2 grid-cols-1 grid-rows-3 gap-x-4 gap-y-4">
          <div className="bg-gray-200 shadow p-2 rounded-xl row-span-2">
            ...
            <ul className="text-md sm:text-[16px]">
              ...
              <br />
              <br />
              Construction of Retaining Wall: A retaining wall is being built
              from (link unavailable)-41-21/1 to 23-41-21/3 at Dayal Nagar Lova
              in Ward 74 of Gajuwaka, with a value of ₹15.90 lakh.
              <br />
              <br />
          ...
          <div className="bg-gray-200 shadow p-2 rounded-xl">
            ...
            <ul className="text-md sm:text-[16px]">
              Shifting/modifications of 220 kV power line crossing works are
              being done for maintaining required railway crossing clearances
              between Loc No.880/5 S-880/6 S.
            </ul>
          </div>
          <div className="bg-gray-200 shadow p-2 rounded-xl">
            <p className="font-bold mt-4 underline text-xl sm:text-[18px]">
          ...
          <div className="bg-gray-200 shadow p-2 rounded-xl">
            ...
            <ul className="text-md sm:text-[16px]">
              A working women&#39;s hostel is being constructed in Gajuwaka
              under the Special Assistance to States for Capital Investment
              2024-25 (SASCI), valued at ₹22.44 crore.
            </ul>
          </div>
        </section>
        <div className="bg-gray-200 shadow p-2 rounded-xl my-3">
          ...
          <ul className="text-md sm:text-[16px]">
            The Visakhapatnam Metropolitan Regional Development Authority
            (VMRDA) is setting up a massive open auditorium in Gajuwaka,
            expected to boost the local economy.
            <br />
            <br />
            Gajuwaka is experiencing growth due to its proximity to industries,
            IT parks, and educational institutions, making it an attractive
            location for residential and commercial real estate investments.
          </ul>
        </div>
      </div>
